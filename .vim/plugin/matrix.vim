...
function! s:Init()
   ...
   " afterwards.
   hi MatrixHidden ctermfg=Black  guifg=#000000 guibg=#000000
   hi MatrixNormal ctermfg=DarkGreen  guifg=#008000 guibg=#000000
   hi MatrixBold ctermfg=LightGreen  guifg=#00ff00 guibg=#000000
   hi MatrixHead ctermfg=White  guifg=#ffffff guibg=#000000
